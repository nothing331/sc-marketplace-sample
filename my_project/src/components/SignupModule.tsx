...
const SignupModule: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen min-w-full">
        ...
        <h2 className="text-2xl font-bold text-center text-black dark:text-white">SalesCode MarketPlace</h2>
        <p className="text-center text-l text-gray-500 dark:text-gray-400">Create Account</p>
